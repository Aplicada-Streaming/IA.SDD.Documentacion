...
Leer `/DEV/Discord.Bot.Moderador.Core.Documentos/ia-db/README.md` y `DEV/SAI.Documentacion/README.md`, esto
 trata sobre un servicio: `Administrador de Bots Moderador para Discord`.

`Administrador de Bots Moderador para Discord` es un servicio cuenta con un flujo de usuario inicial para cuando no posee configuración ofrece una página inicial de diseño.

Lee `/IA/IA.Prompts/README.md`, es trata sobre un `Framework SDD`. En  `/IA/IA.SDD/SDD/Devs/References` se adjunta 
...
2. Revisar y proponer un markdown que extraiga las caracteristicas de `Administrador de Bots Moderador para Discord` implementado sintetizando en mardkown reglas para aplicar en el `SDD` actual
2.a Su flujo de usuario para cuando se despliega por primera vez. Extraer descripciones, patrón de diseño, wireframewes
2.b Sus variantes de parametrización y configuración. 
