...
1. No veo que en el `Documento intake` incluya valores de mediciones o ejemplos dados, es super importante para la etapa de maquetizacion, construcción de pruebas. 

2. Falta una tabla de contenido en el documento `Documento intake` 
